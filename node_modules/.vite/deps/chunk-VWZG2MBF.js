...
var ICONS = {
  add: async () => (await import("./add-YKOBLJK2.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZKMBZTPE.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-FUUFPSFC.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-22GRVDLY.js")).appStoreSvg,
  apple: async () => (await import("./apple-VPMBGAJO.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ZHRKIX3E.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-JCP76O3N.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-LBUSDACY.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-ILCGFER5.js")).arrowTopSvg,
  bank: async () => (await import("./bank-LU5QNRJ6.js")).bankSvg,
  browser: async () => (await import("./browser-TR3I7MJK.js")).browserSvg,
  card: async () => (await import("./card-246VB23P.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7RBY3PB3.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-2RKZPH3E.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-TPFNKBWL.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-OGSGT5V7.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-TIVMAPS5.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-CT7AKPFF.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-MWB3NTVR.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4HMZRAJ2.js")).clockSvg,
  close: async () => (await import("./close-Z72OQPBI.js")).closeSvg,
  compass: async () => (await import("./compass-BZ72ST2U.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-B5AMDTU4.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-BFD2FNMX.js")).copySvg,
  cursor: async () => (await import("./cursor-B55LKWSG.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-HM23JTRM.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-I4KCRBES.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-GTIFWKRO.js")).disconnectSvg,
  discord: async () => (await import("./discord-FWHDSVCR.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-L6WMXQJ6.js")).etherscanSvg,
  extension: async () => (await import("./extension-NHJ2SMUB.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-5QJHDOCA.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-RH66XRDI.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-AKSXEDX3.js")).farcasterSvg,
  filters: async () => (await import("./filters-R3J6KJNK.js")).filtersSvg,
  github: async () => (await import("./github-2MDMZLWR.js")).githubSvg,
  google: async () => (await import("./google-XTTNOYHL.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-7M7LDXTZ.js")).helpCircleSvg,
  image: async () => (await import("./image-XJRSBYTR.js")).imageSvg,
  id: async () => (await import("./id-72AALMUN.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-IACPCMFO.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-UEVV34OB.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DWWZNIHJ.js")).mailSvg,
  mobile: async () => (await import("./mobile-CRNSAYP3.js")).mobileSvg,
  more: async () => (await import("./more-D67IAU6V.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-TQYB2CQ7.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-XOLU57TA.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-ZHAR4KZG.js")).offSvg,
  playStore: async () => (await import("./play-store-FDTT3SSO.js")).playStoreSvg,
  plus: async () => (await import("./plus-TGIECH5A.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-5PQM4P2R.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-Q44LUTWV.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-VCU6ZZHJ.js")).refreshSvg,
  search: async () => (await import("./search-C3GU4UAZ.js")).searchSvg,
  send: async () => (await import("./send-BW5CITNV.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-YPNAXC6Z.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-E3TXSUKS.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-WN3MWAON.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-ONN6WIMM.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-LQQBXFMD.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-CKM6JZJN.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-BT4HSOIF.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-NPZ7MVT3.js")).twitchSvg,
  twitter: async () => (await import("./x-JGWA74B7.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-TL5ESRQ6.js")).twitterIconSvg,
  verify: async () => (await import("./verify-OSF4WLBT.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-BNRIOKL4.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-OUZ66LJV.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-DV34F5T3.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-DV34F5T3.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-DV34F5T3.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-NH4FIRJ4.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-LGFLED5L.js")).warningCircleSvg,
  x: async () => (await import("./x-JGWA74B7.js")).xSvg,
  info: async () => (await import("./info-ZOXP2XV6.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-3LMR56IO.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-VO3L7NWK.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VWZG2MBF.js.map
